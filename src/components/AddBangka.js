    ...
    <div className="main-container">
      <div className="container mt-5 text-center">
        ...
        <div className="row justify-content-center">
          {bangkas.map((bangka) => (
            <div key={bangka.name} className="col-md-3 mb-4">
              <div className="card" onClick={() => handleSelect(bangka)} style={{ cursor: 'pointer' }}>
                <img src={bangka.image} className="card-img-top img-fluid" alt={bangka.name} style={{ height: '200px', objectFit: 'cover' }} />
